...
Exercises for searching and comparing text. The examples use case-sensitive Java `String` operations and explicitly
document null, empty-input, and whitespace behavior.
...
| 4 | [Palindrome Check](easy/_04_is_palindrome/README.md) | Compare mirrored characters case-insensitively from both ends. | [Java](easy/_04_is_palindrome/Palindrome.java) |

## Difficulty

- [Easy](easy/README.md)

[Back to Coding Challenges](../README.md) · [Back to the project overview](../../../README.md)
